...
// https://zhuanlan.zhihu.com/p/572680301
// https://github.com/mozillazg/libbpfgo-tools/blob/master/tools/bashreadline/main.go
...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target native -type str_t bpf readline.c -- -I../../headers
...
func main() {
	...
	up, err := ex.Uretprobe(symbol, objs.Printret, nil)
	if err != nil {
	...
	for {
		...
		log.Printf("%-7d %s\n", event.Pid, unix.ByteSliceToString(event.Str[:]))
	}
}
